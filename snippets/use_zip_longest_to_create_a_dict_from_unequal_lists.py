...
dictionary_from_zip_longest = dict(itertools.zip_longest(my_long_list, my_short_list, fillvalue=None))
print(dictionary_from_zip_longest)
# Response
# {'first_item': 'oranges', 'second_item': 'carrots', 'third_item': 'peas', 'fourth_item': None}